...
try:
    ...
    def trakos(userQ, password):
        ...
        head = {'HOST':'www.instagram.com', 
         'KeepAlive':'True', 
         'user-agent':'Mozilla/5.0 (Linux; Android 9; JKM-LX1 Build/HUAWEIJKM-LX1; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36', 
         'Cookie':cookie, 
         'Accept':'*/*', 
...
- 🌬️🃏𝗨𝗦𝗘𝗥 : {userQ}.
- 🌬️🃏𝗣𝗔𝗦𝗦𝗪𝗢𝗥𝗗 : {password}.
- 🌬️🃏𝗙𝗢𝗟𝗟𝗢𝗪𝗘R𝗦 : {followes}.
- 🌬️🃏𝗙𝗢𝗟𝗟𝗢𝗪𝗜𝗡𝗚 : {following}.
- 🌬️🃏 𝗩𝗘𝗥𝗜𝗙𝗜𝗘𝗗 : {verified}
 -🌬️🃏𝗗𝗔𝗧𝗘 : {dat}.
- - - - - - - - - - - - - -
By : @kank39 ~ @tppt6 💯
